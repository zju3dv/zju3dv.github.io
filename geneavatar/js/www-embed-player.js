...
*/
    ...
    function Ea(a, b) {
        wa(a.h); var c = a.h.l; if (c) return Fa(a, "return" in c ? c["return"] : function (d) { return { value: d, done: !0 } }, b, a.h.return);
    ...
    function Ha(a) {
        this.next = function (b) { wa(a.h); a.h.l ? b = Fa(a, a.h.l.next, b, a.h.M) : (a.h.M(b), b = Ga(a)); return b };
    ...
    n("Promise", function (a) {
        function b(g) { this.h = 0; this.j = void 0; this.i = []; this.v = !1; var h = this.l(); try { g(h.resolve, h.reject) } catch (k) { h.reject(k) } }
        ...
        b.prototype.l = function () {
            function g(m) { return function (q) { k || (k = !0, m.call(h, q)) } }
        ...
        b.prototype.then = function (g, h) {
            function k(w, t) { return "function" == typeof w ? function (y) { try { m(w(y)) } catch (E) { q(E) } } : t }
            var m, q, r = new b(function (w, t) { m = w; q = t });
            this.eb(k(g, m), k(h, q)); return r
        };
        b.prototype.catch = function (g) { return this.then(void 0, g) };
        b.prototype.eb = function (g, h) {
            function k() { switch (m.h) { case 1: g(m.j); break; case 2: h(m.j); break; default: throw Error("Unexpected state: " + m.h); } }
        ...
        b.all = function (g) {
            var h = p(g), k = h.next(); return k.done ? d([]) : new b(function (m, q) {
                function r(y) { return function (E) { w[y] = E; t--; 0 == t && m(w) } }
    ...
    n("WeakMap", function (a) {
        function b(k) { this.h = (h += Math.random() + 1).toString(); if (k) { k = p(k); for (var m; !(m = k.next()).done;)m = m.value, this.set(m[0], m[1]) } }
        function c() { }
    ...
    n("Set", function (a) {
        function b(c) { this.h = new Map; if (c) { c = p(c); for (var d; !(d = c.next()).done;)this.add(d.value) } this.size = this.h.size }
    ...
    }, fb = Array.prototype.forEach ? function (a, b, c) { Array.prototype.forEach.call(a, b, c) } : function (a, b, c) { for (var d = a.length, e = "string" === typeof a ? a.split("") : a, f = 0; f < d; f++)f in e && b.call(c, e[f], f, a) }, gb = Array.prototype.filter ? function (a, b) { return Array.prototype.filter.call(a, b, void 0) } : function (a, b) {
        for (var c = a.length, d = [], e = 0, f = "string" === typeof a ? a.split("") : a, g = 0; g < c; g++)if (g in f) {
            var h = f[g];
            b.call(void 0, h, g, a) && (d[e++] = h)
        } return d
    }, hb = Array.prototype.map ? function (a, b) { return Array.prototype.map.call(a, b, void 0) } : function (a, b) {
        for (var c = a.length, d = Array(c), e = "string" === typeof a ? a.split("") : a, f = 0; f < c; f++)f in e && (d[f] = b.call(void 0, e[f], f, a));
        return d
    }, ib = Array.prototype.reduce ? function (a, b, c) { return Array.prototype.reduce.call(a, b, c) } : function (a, b, c) {
        var d = c;
    ...
    var Oc; a: {
        var Pc = "", Qc = function () { var a = Sb(); if (Kc) return /rv:([^\);]+)(\)|;)/.exec(a); if (Jc) return /Edge\/([\d\.]+)/.exec(a); if (Ic) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a); if (Lc) return /WebKit\/(\S+)/.exec(a); if (Hc) return /(?:Version)[ \/]?(\S+)/.exec(a) }();
        Qc && (Pc = Qc ? Qc[1] : ""); if (Ic) { var Rc = Nc(); if (null != Rc && Rc > parseFloat(Pc)) { Oc = String(Rc); break a } } Oc = Pc
    ...
    function cd(a) {
        var b = a.length, c = 3 * b / 4; c % 3 ? c = Math.floor(c) : -1 != "=.".indexOf(a[b - 1]) && (c = -1 != "=.".indexOf(a[b - 2]) ? c - 2 : c - 1); var d = new Uint8Array(c), e = 0; dd(a, function (f) { d[e++] = f });
        return e !== c ? d.subarray(0, e) : d
    }
    function dd(a, b) {
        function c(k) { for (; d < a.length;) { var m = a.charAt(d++), q = $c[m]; if (null != q) return q; if (!/^[\s\xa0]*$/.test(m)) throw Error("Unknown base64 encoding at char: " + m); } return k }
    ...
    function Zd(a, b, c, d, e, f) {
        a.h || (a.h = {}); var g = a.h[c], h = Ud(a, c, 3, d, f); if (g) f || (Object.isFrozen(g) ? e || (g = Array.prototype.slice.call(g), a.h[c] = g) : e && Object.freeze(g)); else {
            g = []; var k = !!(od(a.C) & 16), m = rd(h); !f && m && (h = qd(Array.prototype.slice.call(h)), Sd(a, c, h, d)); d = m; for (var q = 0; q < h.length; q++) { var r = h[q]; var w = b; var t = k, y = !1; y = void 0 === y ? !1 : y; t = void 0 === t ? !1 : t; w = Array.isArray(r) ? new w(t ? wd(r) : r) : y ? new w : void 0; void 0 !== w && (d = d || rd(r), g.push(w), m && md(w.C, 2)) } a.h[c] = g; a = h; b = !d; Object.isFrozen(a) || (c = od(a) |
                33, pd(a, b ? c | 8 : c & -9)); (f || e && m) && md(g, 2); (f || e) && Object.freeze(g)
        } return g
    }
    ...
    ; function H(a, b, c) {
        null == a && (a = Jd); Jd = void 0; var d = this.constructor.i || 0, e = 0 < d, f = this.constructor.h, g = !1; if (null == a) { a = f ? [f] : []; var h = !0; pd(a, 48) } else { if (!Array.isArray(a)) throw Error(); if (f && f !== a[0]) throw Error(); var k = md(a, 0), m = k; if (h = 0 !== (16 & m)) (g = 0 !== (32 & m)) || (m |= 32); if (e) if (128 & m) d = 0; else { if (0 < a.length) { var q = a[a.length - 1]; if (Bd(q) && "g" in q) { d = 0; m |= 128; delete q.g; var r = !0, w; for (w in q) { r = !1; break } r && a.pop() } } } else if (128 & m) throw Error(); k !== m && pd(a, m) } this.ta = (f ? 0 : -1) - d; this.h = void 0; this.C =
    ...
    we.prototype.preventDefault = function () { this.defaultPrevented = !0 }; function xe(a) {
        var b = B("window.location.href"); null == a && (a = 'Unknown Error of type "null/undefined"'); if ("string" === typeof a) return { message: a, name: "Unknown error", lineNumber: "Not available", fileName: b, stack: "Not available" }; var c = !1; try { var d = a.lineNumber || a.line || "Not available" } catch (g) { d = "Not available", c = !0 } try { var e = a.fileName || a.filename || a.sourceURL || z.$googDebugFname || b } catch (g) { e = "Not available", c = !0 } b = ye(a); if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            c = a.message; if (null ==
    ...
    var ze = {}; var Be = function () {
        if (!z.addEventListener || !Object.defineProperty) return !1; var a = !1, b = Object.defineProperty({}, "passive", { get: function () { a = !0 } });
        try { z.addEventListener("test", function () { }, b), z.removeEventListener("test", function () { }, b) } catch (c) { } return a
    }(); function Ce(a, b) { we.call(this, a ? a.type : ""); this.relatedTarget = this.h = this.target = null; this.button = this.screenY = this.screenX = this.clientY = this.clientX = 0; this.key = ""; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.altKey = this.ctrlKey = !1; this.state = null; this.pointerId = 0; this.pointerType = ""; this.i = null; a && this.init(a, b) }
    Za(Ce, we); var De = { 2: "touch", 3: "pen", 4: "mouse" };
    Ce.prototype.init = function (a, b) {
        var c = this.type = a.type, d = a.changedTouches && a.changedTouches.length ? a.changedTouches[0] : null; this.target = a.target || a.srcElement; this.h = b; if (b = a.relatedTarget) { if (Kc) { a: { try { Gc(b.nodeName); var e = !0; break a } catch (f) { } e = !1 } e || (b = null) } } else "mouseover" == c ? b = a.fromElement : "mouseout" == c && (b = a.toElement); this.relatedTarget = b; d ? (this.clientX = void 0 !== d.clientX ? d.clientX : d.pageX, this.clientY = void 0 !== d.clientY ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY = d.screenY ||
    ...
    var cf = "__closure_events_fn_" + (1E9 * Math.random() >>> 0); function Ve(a) {
        if ("function" === typeof a) return a; a[cf] || (a[cf] = function (b) { return a.handleEvent(b) });
        return a[cf]
    }
    ...
    ; var pf; function qf() {
        var a = z.MessageChannel; "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !C("Presto") && (a = function () {
            var e = nf("IFRAME"); e.style.display = "none"; document.documentElement.appendChild(e); var f = e.contentWindow; e = f.document; e.open(); e.close(); var g = "callImmediate" + Math.random(), h = "file:" == f.location.protocol ? "*" : f.location.protocol + "//" + f.location.host; e = Xa(function (k) { if (("*" == h || k.origin == h) && k.data == g) this.port1.onmessage() }, this);
            f.addEventListener("message", e, !1); this.port1 = {}; this.port2 = { postMessage: function () { f.postMessage(g, h) } }
        });
        if ("undefined" !== typeof a && !Tb()) {
            var b = new a, c = {}, d = c; b.port1.onmessage = function () { if (void 0 !== c.next) { c = c.next; var e = c.Rb; c.Rb = null; e() } };
            return function (e) { d.next = { Rb: e }; d = d.next; b.port2.postMessage(0) }
    ...
    function yf() {
        if (z.Promise && z.Promise.resolve) { var a = z.Promise.resolve(void 0); uf = function () { a.then(zf) } } else uf = function () {
            var b = zf;
    ...
    function Gf(a, b, c, d) {
        var e = Ef(null, null, null); e.h = new Af(function (f, g) {
            e.j = b ? function (h) { try { var k = b.call(d, h); f(k) } catch (m) { g(m) } } : f;
    ...
    l.tb = function () {
        var a = this.h.values(); a = [].concat(ia(a)).filter(function (b) { return b.Aa.size });
    ...
    function og(a, b, c) {
        var d = [], e = []; if (1 == (Array.isArray(c) ? 2 : 1)) return e = [b, a], fb(d, function (h) { e.push(h) }), pg(e.join(" "));
    ...
    l.set = function (a, b, c) {
        var d = !1; if ("object" === typeof c) { var e = c.Fr; d = c.secure || !1; var f = c.domain || void 0; var g = c.path || void 0; var h = c.ib } if (/[;=\s]/.test(a)) throw Error('Invalid cookie name "' + a + '"'); if (/[;\r\n]/.test(b)) throw Error('Invalid cookie value "' + b + '"'); void 0 === h && (h = -1); c = f ? ";domain=" + f : ""; g = g ? ";path=" + g : ""; d = d ? ";secure" : ""; h = 0 > h ? "" : 0 == h ? ";expires=" + (new Date(1970, 1, 1)).toUTCString() : ";expires=" + (new Date(Date.now() + 1E3 * h)).toUTCString(); this.h.cookie = a + "=" + b + c + g + h + d + (null != e ? ";samesite=" +
            e : "")
    };
    ...
    function Cg(a, b, c) {
        if (null == b) c.push("null"); else {
            if ("object" == typeof b) { if (Array.isArray(b)) { var d = b; b = d.length; c.push("["); for (var e = "", f = 0; f < b; f++)c.push(e), Cg(a, d[f], c), e = ","; c.push("]"); return } if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf(); else { c.push("{"); e = ""; for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (f = b[d], "function" != typeof f && (c.push(e), Eg(d, c), c.push(":"), Cg(a, f, c), e = ",")); c.push("}"); return } } switch (typeof b) {
                case "string": Eg(b, c); break; case "number": c.push(isFinite(b) &&
    ...
    l.send = function (a, b, c, d) {
        ...
        e = z.FormData && a instanceof z.FormData; !(0 <= eb(Og, b)) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); b = p(c); for (d = b.next(); !d.done; d = b.next())c = p(d.value), d = c.next().value, c = c.next().value, this.A.setRequestHeader(d, c); this.ca && (this.A.responseType = this.ca); "withCredentials" in this.A && this.A.withCredentials !== this.W && (this.A.withCredentials = this.W); try {
            Ug(this), 0 < this.o && (this.V = Vg(this.A), this.getStatus(), this.V ? (this.A.timeout = this.o, this.A.ontimeout = Xa(this.vc, this)) :
                this.F = Tf(this.vc, this.o, this)), this.getStatus(), this.s = !0, this.A.send(a), this.s = !1
        } catch (g) { this.getStatus(), Rg(this, g) }
    };
    ...
    function Xg(a, b) {
        if (a.A) {
            Ug(a); var c = a.A, d = a.I[0] ? function () { } : null;
    ...
    u(lh, H); var mh; mh = new function (a, b, c) { this.i = a; this.fieldName = b; this.h = c; this.isRepeated = 0; this.j = ne }(175237375, { vr: 0 }, lh); function nh(a, b, c, d, e, f, g, h, k, m, q) {
        df.call(this); var r = this; this.O = ""; this.j = []; this.Mb = ""; this.Nb = this.sa = -1; this.Ya = !1; this.I = this.m = null; this.F = 0; this.Dc = 1; this.timeoutMillis = 0; this.ca = !1; df.call(this); this.Za = b || function () { };
    ...
    nh.prototype.flush = function (a, b) {
        var c = this; if (0 === this.j.length) a && a(); else if (this.ca) uh(this); else {
            var d = Date.now(); if (this.Nb > d && this.sa < d) b && b("throttled"); else {
                var e = vh(this.s, this.j, this.F); d = {}; var f = this.Za(); f && (d.Authorization = f); var g = rh(this); this.K && (d["X-Goog-AuthUser"] = this.K, g = vc(g, "authuser", this.K)); this.pageId && (d["X-Goog-PageId"] = this.pageId, g = vc(g, "pageId", this.pageId)); if (f && this.Mb === f) b && b("stale-auth-token"); else {
                    this.j = []; this.i.enabled && this.i.stop(); this.F = 0; var h = ke(e),
                        k; this.I && this.I.isSupported(h.length) && (k = this.I.compress(h)); var m = { url: g, body: h, Ic: 1, Gb: d, requestType: "POST", withCredentials: this.withCredentials, timeoutMillis: this.timeoutMillis }, q = function (t) { c.o.reset(); Sf(c.i, c.o.getValue()); if (t) { var y = null; try { var E = JSON.parse(t.replace(")]}'\n", "")); y = new jh(E) } catch (F) { } y && (t = Number(ee(Rd(y, 1), "-1")), 0 < t && (c.sa = Date.now(), c.Nb = c.sa + t), y = mh.j(y)) && (y = ee(Rd(y, 1), -1), -1 != y && (c.Ya || sh(c, y))) } a && a() }, r = function (t, y) {
                            var E = $d(e, fh, 3), F = c.o;
                            F.h = Math.min(3E5, 2 * F.h); F.i = Math.min(3E5, F.h + Math.round(.2 * (Math.random() - .5) * F.h)); Sf(c.i, c.o.getValue()); 401 === t && f && (c.Mb = f); void 0 === y && (y = 500 <= t && 600 > t || 401 === t || 0 === t); y && (c.j = E.concat(c.j), c.V || c.i.enabled || c.i.start()); b && b("net-send-failed", t)
                        }, w = function () { c.Xa ? c.Xa.send(m, q, r) : c.Bc(m, q, r) };
    ...
    Bh.prototype.flush = function (a) {
        var b = a || []; if (b.length) {
            a = new jg; for (var c = [], d = 0; d < b.length; d++) {
                var e = b[d], f = e, g = new bg; var h = D(g, 1, f.i); var k = f; g = []; for (var m = 0; m < k.h.length; m++)g.push(k.h[m].La); if (null == g) g = Dd; else { for (k = 0; k < g.length; k++); g = zd(g, 5) } g = D(h, 3, g); h = []; k = []; m = p(f.Aa.keys()); for (var q = m.next(); !q.done; q = m.next())k.push(q.value.split(",")); for (m = 0; m < k.length; m++) {
                    q = k[m]; var r = f.l; for (var w = f.ub(q) || [], t = [], y = 0; y < w.length; y++) {
                        var E = w[y]; E = E && E.Sb; var F = new gg; switch (r) {
                            case 3: Vd(F,
                                1, ig, Number(E)); break; case 2: Vd(F, 2, ig, Number(E))
                        }t.push(F)
                    } r = t; for (w = 0; w < r.length; w++) { t = r[w]; y = new dg; t = G(y, gg, 2, t); y = q; E = []; F = f; for (var O = [], N = 0; N < F.h.length; N++)O.push(F.h[N].Ma); F = O; for (O = 0; O < F.length; O++) { N = F[O]; var R = y[O], ca = new fg; switch (N) { case 3: Vd(ca, 1, hg, String(R)); break; case 2: Vd(ca, 2, hg, Number(R)); break; case 1: Vd(ca, 3, hg, "true" == R) }E.push(ca) } be(t, fg, 1, E); h.push(t) }
                } be(g, dg, 4, h); c.push(g); e.clear()
            } be(a, bg, 1, c); b = this.h; a instanceof fh ? b.log(a) : (c = new fh, a = ke(a), a = D(c, 8, a), b.log(a));
            this.h.flush()
        }
    }; function Ch(a) { this.wa = a; this.v = Dh(); this.l = new Bh; this.h = new Uf(this.l); this.o = new Zf(this.h); this.i = new $f(this.h); this.j = new ag(this.h); this.m = new Yf(this.h) }
    ...
    Fh.prototype.snapshot = function (a) {
        var b = this; if (this.i) throw Error("Already disposed"); var c = Dh(), d; null != (d = this.la) && d.i.h.rb("/client_streamz/bg/fsc", d.wa); return this.j.then(function (e) {
            var f = e.Gc; return new Promise(function (g) {
                f(function (h) { var k; if (null != (k = b.la)) { var m = Dh() - c; k.j.h.sb("/client_streamz/bg/fsl", m, k.wa) } g(h) }, [a.Ub,
                a.vd])
            })
        })
    };
...
*/
    ...
    function Rh() {
        var a = Sh(), b = {}; fb(Qh(), function (c) { a.sandbox && a.sandbox.supports && a.sandbox.supports(c) && (b[c] = !0) });
        return b
    }
    ...
    ; var Uh = (new Date).getTime(); var Vh = "client_dev_domain client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" "); ia(Vh); function Wh(a) {
        df.call(this); var b = this; this.s = this.j = 0; this.Y = null != a ? a : {
            R: function (e, f) { return setTimeout(e, f) },
    ...
    function Xh(a, b) {
        return a.o ? a.o : a.o = new Promise(function (c) {
            var d, e, f, g; return x(function (h) {
                switch (h.h) {
                    case 1: return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, ya(h, 2, 3), d && (a.j = a.Y.R(function () { d.abort() }, b || 2E4)), v(h, fetch("/generate_204", {
                        method: "HEAD",
                        signal: f
                    }), 5); case 5: g = !0; case 3: Ba(h); a.o = void 0; a.j && (a.Y.ea(a.j), a.j = 0); g !== a.i && (a.i = g, a.i ? ef(a, "networkstatus-online") : ef(a, "networkstatus-offline")); c(g); Ca(h); break; case 2: Aa(h), g = !1, h.u(3)
                }
            })
        })
    }
    ...
    function bi(a) {
        -1 === a.h && (a.h = ib(a.data_, function (b, c, d) { return c ? b + Math.pow(2, d) : b }, 0));
        return a.h
    }
    ...
    function gi(a, b, c) {
        c || (c = 0); var d = a.o; if ("string" === typeof b) for (var e = 0; 16 > e; e++)d[e] = b.charCodeAt(c) << 24 | b.charCodeAt(c + 1) << 16 | b.charCodeAt(c + 2) << 8 | b.charCodeAt(c + 3), c += 4; else for (e = 0; 16 > e; e++)d[e] = b[c] << 24 | b[c + 1] << 16 | b[c + 2] << 8 | b[c + 3], c += 4; for (e = 16; 80 > e; e++) { var f = d[e - 3] ^ d[e - 8] ^ d[e - 14] ^ d[e - 16]; d[e] = (f << 1 | f >>> 31) & 4294967295 } b = a.h[0]; c = a.h[1]; var g = a.h[2], h = a.h[3], k = a.h[4]; for (e = 0; 80 > e; e++) {
            if (40 > e) if (20 > e) { f = h ^ c & (g ^ h); var m = 1518500249 } else f = c ^ g ^ h, m = 1859775393; else 60 > e ? (f = c & g | h & (c | g), m = 2400959708) :
                (f = c ^ g ^ h, m = 3395469782); f = (b << 5 | b >>> 27) + f + k + m + d[e] & 4294967295; k = h; h = g; g = (c << 30 | c >>> 2) & 4294967295; c = b; b = f
    ...
    li.prototype.da = function () { return this }; function oi(a) {
        if (a instanceof pi || a instanceof qi || a instanceof ri) return a; if ("function" == typeof a.next) return new pi(function () { return a });
    ...
    function ri(a) {
        pi.call(this, function () { return a });
        this.j = a
    }
    ...
    l.da = function (a) {
        ti(this); var b = 0, c = this.oa, d = this, e = new li; e.next = function () { if (c != d.oa) throw Error("The map has changed since the iterator was created"); if (b >= d.h.length) return mi; var f = d.h[b++]; return ni(a ? f : d.i[f]) };
        return e
    };
    ...
    l.da = function (a) {
        var b = 0, c = this.h, d = new li; d.next = function () { if (b >= c.length) return mi; var e = c.key(b++); if (a) return ni(e); e = c.getItem(e); if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return ni(e) };
        return d
    };
    ...
    l.da = function (a) {
        var b = 0, c = this.h.XMLDocument.documentElement.attributes, d = new li; d.next = function () { if (b >= c.length) return mi; var e = c[b++]; if (a) return ni(decodeURIComponent(e.nodeName.replace(/\./g, "%")).slice(1)); e = e.nodeValue; if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return ni(e) };
        return d
    };
    ...
    Mi.prototype.da = function (a) {
        var b = this.i[Symbol.iterator](), c = this, d = new li; d.next = function () { var e = b.next(); if (e.done) return e; for (e = e.value; e.slice(0, c.h.length) != c.h;) { e = b.next(); if (e.done) return e; e = e.value } return ni(a ? e.slice(c.h.length) : c.i.get(e)) };
        return d
    ...
    var $k = String(Yk); function al(a) {
        var b = []; mb(a, function (c, d) { var e = encodeURIComponent(String(d)), f; Array.isArray(c) ? f = c : f = [c]; fb(f, function (g) { "" == g ? b.push(e) : b.push(e + "=" + encodeURIComponent(String(g))) }) });
        return b.join("&")
    }
    ...
    ; function fl(a) {
        var b = gl; a = void 0 === a ? B("yt.ads.biscotti.lastId_") || "" : a; var c = Object, d = c.assign, e = {}; e.dt = Uh; e.flash = "0"; a: { try { var f = b.h.top.location.href } catch (ea) { f = 2; break a } f = f ? f === b.i.location.href ? 0 : 1 : 2 } e = (e.frm = f, e); try {
            e.u_tz = -(new Date).getTimezoneOffset(); var g = void 0 === g ? Gh : g; try { var h = g.history.length } catch (ea) { h = 0 } e.u_his = h; var k; e.u_h = null == (k = Gh.screen) ? void 0 : k.height; var m; e.u_w = null == (m = Gh.screen) ? void 0 : m.width; var q; e.u_ah = null == (q = Gh.screen) ? void 0 : q.availHeight; var r; e.u_aw =
                null == (r = Gh.screen) ? void 0 : r.availWidth; var w; e.u_cd = null == (w = Gh.screen) ? void 0 : w.colorDepth
        } catch (ea) { } h = b.h; try { var t = h.screenX; var y = h.screenY } catch (ea) { } try { var E = h.outerWidth; var F = h.outerHeight } catch (ea) { } try { var O = h.innerWidth; var N = h.innerHeight } catch (ea) { } try { var R = h.screenLeft; var ca = h.screenTop } catch (ea) { } try { O = h.innerWidth, N = h.innerHeight } catch (ea) { } try { var U = h.screen.availWidth; var rb = h.screen.availTop } catch (ea) { } t = [R, ca, t, y, U, rb, E, F, O, N]; try {
            var Va = (b.h.top || window).document, na = "CSS1Compat" ==
                Va.compatMode ? Va.documentElement : Va.body; var I = (new lf(na.clientWidth, na.clientHeight)).round()
        } catch (ea) { I = new lf(-12245933, -12245933) } Va = I; I = {}; var ma = void 0 === ma ? z : ma; na = new ai; ma.SVGElement && ma.document.createElementNS && na.set(0); y = Rh(); y["allow-top-navigation-by-user-activation"] && na.set(1); y["allow-popups-to-escape-sandbox"] && na.set(2); ma.crypto && ma.crypto.subtle && na.set(3); ma.TextDecoder && ma.TextEncoder && na.set(4); ma = bi(na); I.bc = ma; I.bih = Va.height; I.biw = Va.width; I.brdim = t.join(); b = b.i; b = (I.vis =
    ...
    }, ml = "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(ia(Vh)), nl = !1;
    function ol(a, b) {
        b = void 0 === b ? {} : b; var c = el(a), d = M("web_ajax_ignore_global_headers_if_set"), e; for (e in ll) { var f = L(ll[e]); "X-Goog-Visitor-Id" !== e || f || (f = L("VISITOR_DATA")); !f || !c && nc(a) || d && void 0 !== b[e] || (b[e] = f) } "X-Goog-EOM-Visitor-Id" in b && "X-Goog-Visitor-Id" in b && delete b["X-Goog-Visitor-Id"]; if (c || !nc(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset()); if (c || !nc(a)) { try { var g = (new Intl.DateTimeFormat).resolvedOptions().timeZone } catch (h) { } g && (b["X-YouTube-Time-Zone"] = g) } document.location.hostname.endsWith("youtubeeducation.com") ||
            !c && nc(a) || (b["X-YouTube-Ad-Signals"] = al(fl())); return b
    }
    function pl(a) {
        var b = window.location.search, c = nc(a); M("debug_handle_relative_url_for_query_forward_killswitch") || !c && el(a) && (c = document.location.hostname); var d = lc(mc(5, a)); d = (c = c && (c.endsWith("youtube.com") || c.endsWith("youtube-nocookie.com"))) && d && d.startsWith("/api/"); if (!c || d) return a; var e = bl(b), f = {}; fb(ml, function (g) { e[g] && (f[g] = e[g]) });
        return dl(a, f || {}, !1)
    }
    function ql(a, b) {
        var c = b.format || "JSON"; a = rl(a, b); var d = sl(a, b), e = !1, f = tl(a, function (k) {
            if (!e) {
    ...
    function sl(a, b) {
        var c = L("XSRF_FIELD_NAME"), d = L("XSRF_TOKEN"), e = b.postBody || "", f = b.postParams, g = L("XSRF_FIELD_NAME"), h; b.headers && (h = b.headers["Content-Type"]); b.excludeXsrf || nc(a) && !b.withCredentials && nc(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d); (M("ajax_parse_query_data_only_when_filled") && f && 0 < Object.keys(f).length || f) && "string" === typeof e && (e = bl(e), xb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ?
            JSON.stringify(e) : sc(e)); f = e || f && !pb(f); !nl && f && "POST" != b.method && (nl = !0, Rk(Error("AJAX request with postData should use POST"))); return e
    }
    function ul(a, b, c, d) {
        var e = null; switch (b) { case "JSON": try { var f = c.responseText } catch (g) { throw d = Error("Error reading responseText"), d.params = a, Sk(d), g; } a = c.getResponseHeader("Content-Type") || ""; f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f)); break; case "XML": if (a = (a = c.responseXML) ? vl(a) : null) e = {}, fb(a.getElementsByTagName("*"), function (g) { e[g.tagName] = wl(g) }) }d && xl(e);
        return e
    }
    ...
    function wl(a) {
        var b = ""; fb(a.childNodes, function (c) { b += c.nodeValue });
        return b
    }
    function tl(a, b, c, d, e, f, g) {
        function h() { 4 == (k && "readyState" in k ? k.readyState : 0) && b && Qk(b)(k) }
    ...
    ; function yl(a) {
        var b = this; this.i = void 0; this.h = !1; a.addEventListener("beforeinstallprompt", function (c) { c.preventDefault(); b.i = c });
    ...
    Na(El); var Jl = { bluetooth: "CONN_DISCO", cellular: "CONN_CELLULAR_UNKNOWN", ethernet: "CONN_WIFI", none: "CONN_NONE", wifi: "CONN_WIFI", wimax: "CONN_CELLULAR_4G", other: "CONN_UNKNOWN", unknown: "CONN_UNKNOWN", "slow-2g": "CONN_CELLULAR_2G", "2g": "CONN_CELLULAR_2G", "3g": "CONN_CELLULAR_3G", "4g": "CONN_CELLULAR_4G" }, Kl = {
    ...
    function Dm(a) {
        function b(e) { if ("PENDING" === d.state.status) { d.state = { status: "REJECTED", reason: e }; e = p(d.i); for (var f = e.next(); !f.done; f = e.next())f = f.value, f() } }
    ...
    l.update = function (a) { return Jm(this.cursor.update(a)) }; function bn(a, b, c) {
        return new Promise(function (d, e) {
            function f() { w || (w = new Mm(g.result, { closed: r })); return w }
            var g = void 0 !== b ? self.indexedDB.open(a, b) : self.indexedDB.open(a); var h = c.Hc, k = c.blocking, m = c.xd, q = c.upgrade, r = c.closed, w; g.addEventListener("upgradeneeded", function (t) {
                try {
                    if (null === t.newVersion) throw Error("Invariant: newVersion on IDbVersionChangeEvent is null"); if (null === g.transaction) throw Error("Invariant: transaction on IDbOpenDbRequest is null"); t.dataLoss && "none" !== t.dataLoss && lm("IDB_DATA_CORRUPTED", { reason: t.dataLossMessage || "unknown reason", dbName: nm(a) }); var y = f(), E = new Rm(g.transaction);
                    q && q(y, function (F) { return t.oldVersion < F && t.newVersion >= F }, E);
                    E.done.catch(function (F) { e(F) })
                } catch (F) { e(F) }
            });
            g.addEventListener("success", function () {
                var t = g.result; k && t.addEventListener("versionchange", function () { k(f()) });
    ...
    function dn(a, b) {
        b = void 0 === b ? {} : b; var c, d, e, f; return x(function (g) {
            if (1 == g.h) return ya(g, 2), c = self.indexedDB.deleteDatabase(a), d = b, (e = d.Hc) && c.addEventListener("blocked", function () { e() }), v(g, Im(c), 4);
    ...
    function jn(a) {
        function b() {
            var f, g, h, k, m, q, r, w, t, y; return x(function (E) {
                switch (E.h) {
        ...
        if (!a.l) throw gn(a); if (a.h) return a.h; var d = {
            blocking: function (f) { f.close() },
            closed: c, xd: c, upgrade: a.options.upgrade
    ...
    function qn(a) {
        var b, c; return x(function (d) {
            if (1 == d.h) return b = Yl("YtIdbMeta hasAnyMeta other"), v(d, nn(function (e) { return void 0 !== e.userIdentifier && e.userIdentifier !== b }, a), 2);
    ...
    function Fn(a, b, c) {
        a = a.map(function (d) { return x(function (e) { return 1 == e.h ? v(e, dn(d.actualName, b), 2) : v(e, mn(d.actualName, c), 0) }) });
    ...
    ; var Ln = {}, Mn = Kn("ytGcfConfig", {
        Da: (Ln.coldConfigStore = { Ia: 1 }, Ln.hotConfigStore = { Ia: 1 }, Ln), pb: !1, upgrade: function (a, b) { b(1) && (Vm(Om(a, "hotConfigStore", { keyPath: "key", autoIncrement: !0 }), "hotTimestampIndex", "timestamp"), Vm(Om(a, "coldConfigStore", { keyPath: "key", autoIncrement: !0 }), "coldTimestampIndex", "timestamp")) },
        version: 1
    }); function Nn(a) { return hn(Mn(), a) }
    ...
    function bo(a) {
        var b = new fj, c = new Xi; D(c, 1, a.ec); D(c, 2, a.dc); D(c, 16, a.Uc); D(c, 17, a.innertubeContextClientVersion); if (a.yb) { var d = a.yb, e = new Ti; d.coldConfigData && D(e, 1, d.coldConfigData); d.appInstallData && D(e, 6, d.appInstallData); d.coldHashData && D(e, 3, d.coldHashData); d.hotHashData && D(e, 5, d.hotHashData); G(c, Ti, 62, e) } (d = z.devicePixelRatio) && 1 != d && D(c, 65, d); d = Mk(); "" !== d && D(c, 54, d); d = Nk(); if (0 < d.length) {
            e = new Zi; for (var f = 0; f < d.length; f++) { var g = new Ri; D(g, 1, d[f].key); Vd(g, 2, Si, d[f].value); ce(e, 15, Ri, g) } G(b,
                Zi, 5, e)
        } Wn(a, c); M("enable_third_party_info") && Xn(b); Yn(c); Zn(a, c); $n(c); M("start_sending_config_hash") && ao(c); L("DELEGATED_SESSION_ID") && !M("pageid_as_header_web") && (a = new dj, D(a, 3, L("DELEGATED_SESSION_ID"))); a = p(Object.entries(bl(L("DEVICE", "")))); for (d = a.next(); !d.done; d = a.next())e = p(d.value), d = e.next().value, e = e.next().value, "cbrand" === d ? D(c, 12, e) : "cmodel" === d ? D(c, 13, e) : "cbr" === d ? D(c, 87, e) : "cbrver" === d ? D(c, 88, e) : "cos" === d ? D(c, 18, e) : "cosver" === d ? D(c, 19, e) : "cplatform" === d && D(c, 42, e); b.i(c); return b
    }
    ...
    ; function lo(a) {
        this.bb = this.h = !1; this.potentialEsfErrorCounter = this.i = 0; this.handleError = function () { };
        this.Ca = function () { };
    ...
    l = lo.prototype; l.writeThenSend = function (a, b) {
        var c = this; b = void 0 === b ? {} : b; if (mo(this) && this.h) {
            var d = { url: a, options: b, timestamp: this.now(), status: "NEW", sendCount: 0 }; this.N.set(d, this.H).then(function (e) { d.id = e; c.L.U() && po(c, d) }).catch(function (e) {
                po(c, d);
                qo(c, e)
            })
        } else this.ia(a, b)
    ...
    l.sendThenWrite = function (a, b, c) {
        var d = this; b = void 0 === b ? {} : b; if (mo(this) && this.h) {
            var e = { url: a, options: b, timestamp: this.now(), status: "NEW", sendCount: 0 }; this.J && this.J("nwl_skip_retry") && (e.skipRetry = c); if (this.L.U() || this.J && this.J("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    var f = b.onError ? b.onError : function () { };
                    b.onError = function (g, h) {
                        return x(function (k) {
                            if (1 == k.h) return v(k, d.N.set(e, d.H).catch(function (m) { qo(d, m) }), 2);
                            f(g, h); k.h = 0
                        })
                    }
    ...
    l.sendAndWrite = function (a, b) {
        var c = this; b = void 0 === b ? {} : b; if (mo(this) && this.h) {
            ...
            this.ia(d.url, d.options); this.N.set(d, this.H).then(function (g) { d.id = g; e && c.N.Ba(d.id, c.H) }).catch(function (g) { qo(c, g) })
        } else this.ia(a, b)
    };
    ...
    function Co(a) {
        var b = Do, c = Bo(); if (!c) return 0; var d = c.subscribe(b.toString(), function (e, f) {
            var g = B("ytPubsub2Pubsub2SkipSubKey"); g && g == d || (g = function () {
                if (xo[d]) try {
                    if (f && b instanceof vo && b != e) try {
                        var h = b.h, k = f; if (!k.args || !k.version) throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete."); try { if (!h.oa) { var m = new h; h.oa = m.version } var q = h.oa } catch (F) { } if (!q || k.version != q) throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible."); try {
                            q = Reflect; var r = q.construct;
                            var w = k.args, t = w.length; if (0 < t) { var y = Array(t); for (k = 0; k < t; k++)y[k] = w[k]; var E = y } else E = []; f = r.call(q, h, E)
                        } catch (F) { throw F.message = "yt.pubsub2.Data.deserialize(): " + F.message, F; }
                    } catch (F) { throw F.message = "yt.pubsub2.pubsub2 cross-binary conversion error for " + b.toString() + ": " + F.message, F; } a.call(window, f)
                } catch (F) { Rk(F) }
            }, zo[b.toString()] ? B("yt.scheduler.instance") ? $h.R(g) : kl(g, 0) : g())
        });
        xo[d] = !0; yo[b.toString()] || (yo[b.toString()] = []); yo[b.toString()].push(d); return d
    }
    function Eo() {
        var a = Fo, b = Co(function (c) { a.apply(void 0, arguments); Go(b) });
        return b
    }
    ...
    function Mo(a, b) {
        var c, d, e, f, g, h, k; return x(function (m) {
            if (1 == m.h) return c = { startTime: Q(), transactionType: "YT_IDB_TRANSACTION_TYPE_READ" }, v(m, Jo(b), 2); if (3 != m.h) return d = m.i, e = L("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, Q()], h = IDBKeyRange.bound(f, g), k = void 0, v(m, Nm(d, ["LogsRequestsStore"], { mode: "readwrite", T: !0 }, function (q) {
                return $m(q.objectStore("LogsRequestsStore").index("newRequestV2"), { query: h, direction: "prev" }, function (r) {
    ...
    ; var So = {}, To = Kn("ServiceWorkerLogsDatabase", {
        Da: (So.SWHealthLog = { Ia: 1 }, So), pb: !0, upgrade: function (a, b) { b(1) && Vm(Om(a, "SWHealthLog", { keyPath: "id", autoIncrement: !0 }), "swHealthNewRequest", ["interface", "timestamp"]) },
        version: 1
    }); function Uo(a) { return hn(To(), a) }
    ...
    ; var Xo = {}, Yo = 0; function Zo(a) {
        var b = new Image, c = "" + Yo++; Xo[c] = b; b.onload = b.onerror = function () { delete Xo[c] };
        b.src = a
    }
    ...
    l.ob = function (a) {
        a = Xh(this.i, a); a.then(function (b) { M("use_cfr_monitor") && ap().requestComplete("generate_204", b) });
        return a
    };
    ...
    u(jp, lo); function mp() {
        var a = B("yt.networklessRequestController.instance"); a || (a = new jp, A("yt.networklessRequestController.instance", a), M("networkless_logging") && wn().then(function (b) { a.H = b; no(a); a.j.resolve(); a.gb && Math.random() <= a.fb && a.H && Vo(a.H); M("networkless_immediately_drop_sw_health_store") && np(a) }));
        return a
    }
    ...
    function kp(a, b, c) {
        M("use_cfr_monitor") && op(a, b); if (M("use_request_time_ms_header")) b.headers && (b.headers["X-Goog-Request-Time"] = JSON.stringify(Math.round(Q()))); else { var d; if (null == (d = b.postParams) ? 0 : d.requestTimeMs) b.postParams.requestTimeMs = Math.round(Q()) } if (c && 0 === Object.keys(b).length) {
            var e = void 0 === e ? "" : e; var f = void 0 === f ? !1 : f; if (a) if (e) tl(a, void 0, "POST", e); else if (L("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) tl(a, void 0, "GET", "", void 0, void 0, f); else {
                b: {
                    try {
                        var g = new bb({ url: a }); if (g.j && g.i ||
                            g.l) { var h = lc(mc(5, a)), k; if (!(k = !h || !h.endsWith("/aclk"))) { var m = a.search(xc), q = wc(a, 0, "ri", m); if (0 > q) var r = null; else { var w = a.indexOf("&", q); if (0 > w || w > m) w = m; r = decodeURIComponent(a.slice(q + 3, -1 !== w ? w : 0).replace(/\+/g, " ")) } k = "1" !== r } var t = !k; break b }
                    } catch (E) { } t = !1
                } if (t) { b: { try { if (window.navigator && window.navigator.sendBeacon && window.navigator.sendBeacon(a, "")) { var y = !0; break b } } catch (E) { } y = !1 } c = y ? !0 : !1 } else c = !1; c || Zo(a)
            }
        } else ql(a, b)
    }
    function op(a, b) {
    ...
    function ko(a, b, c, d) {
        function e(y) {
            y = void 0 === y ? !1 : y; var E; if (d.retry && "www.youtube-nocookie.com" != h && (y || M("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (E = ho(b, c, m, k)), E)) {
                var F = g.onSuccess, O = g.onFetchSuccess; g.onSuccess = function (N, R) { io(E); F(N, R) };
                c.onFetchSuccess = function (N, R) { io(E); O(N, R) }
            } try { y && d.retry && !d.hc.bypassNetworkless ? (g.method = "POST", d.hc.writeThenSend ? mp().writeThenSend(t, g) : mp().sendAndWrite(t, g)) : M("web_all_payloads_via_jspb") ? ql(t, g) : (g.method = "POST", g.postParams || (g.postParams = {}), ql(t, g)) } catch (N) {
                if ("InvalidAccessError" == N.name) E && (io(E), E = 0), Sk(Error("An extension is blocking network request."));
                else throw N;
            } E && Rl(function () { jo(a) }, 5E3)
        }
        !L("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Sk(new P("Missing VISITOR_DATA when sending innertube request.", b, c, d)); if (!a.isReady()) { var f = new P("innertube xhrclient not ready", b, c, d); Rk(f); throw f; } var g = {
    ...
    function gq(a) {
        this.type = ""; this.state = this.source = this.data = this.currentTarget = this.relatedTarget = this.target = null; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.ctrlKey = this.altKey = !1; this.rotation = this.clientY = this.clientX = 0; this.scale = 1; this.changedTouches = this.touches = null; try {
            if (a = a || window.event) {
                this.event = a; for (var b in a) b in Ip || (this[b] = a[b]); this.scale = a.scale; this.rotation = a.rotation; var c = a.target || a.srcElement; c && 3 == c.nodeType && (c = c.parentNode); this.target = c; var d = a.relatedTarget;
    ...
    function lq(a, b, c, d) {
        d = void 0 === d ? {} : d; if (!a || !a.addEventListener && !a.attachEvent) return ""; var e = jq(a, b, c, d); if (e) return e; e = ++iq.count + ""; var f = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document); var g = f ? function (h) { h = new gq(h); if (!of(h.relatedTarget, function (k) { return k == a })) return h.currentTarget = a, h.type = b, c.call(a, h) } : function (h) {
            h = new gq(h);
    ...
    function qq(a) {
        var b = void 0 === a ? {} : a; a = void 0 === b.ed ? !1 : b.ed; b = void 0 === b.Oc ? !0 : b.Oc; if (null == B("_lact", window)) {
            var c = parseInt(L("LACT"), 10); c = isFinite(c) ? Date.now() - Math.max(c, 0) : -1; A("_lact", c, window); A("_fact", c, window); -1 == c && rq(); lq(document, "keydown", rq); lq(document, "keyup", rq); lq(document, "mousedown", rq); lq(document, "mouseup", rq); a ? lq(window, "touchmove", function () { sq("touchmove", 200) }, { passive: !0 }) : (lq(window, "resize", function () { sq("resize", 200) }), b && lq(window, "scroll", function () { sq("scroll", 200) }));
    ...
    ; var uq = z.ytPubsubPubsubInstance || new K, vq = z.ytPubsubPubsubSubscribedKeys || {}, wq = z.ytPubsubPubsubTopicToKeys || {}, xq = z.ytPubsubPubsubIsSynchronous || {}; function yq(a, b) {
        var c = zq(); if (c && b) {
            var d = c.subscribe(a, function () {
                var e = arguments; var f = function () { vq[d] && b.apply && "function" == typeof b.apply && b.apply(window, e) };
                try { xq[a] ? f() : kl(f, 0) } catch (g) { Rk(g) }
            }, void 0);
            vq[d] = !0; wq[a] || (wq[a] = []); wq[a].push(d); return d
        } return 0
    }
    ...
    function lr(a, b, c) {
        a = void 0 === a ? {} : a; c = void 0 === c ? !1 : c; !c && M("web_all_payloads_via_jspb") && Sk(new P("transport.flushLogs called for JSON in JSPB only experiment")); new Af(function (d, e) {
            c ? (rr(Xq.i), rr(Xq.h), Xq.h = 0) : (rr(Wq.i), rr(Wq.h), Wq.h = 0); if (Uq && Uq.isReady()) if (M("use_new_in_memory_storage")) {
                var f = a, g = c, h = Uq; f = void 0 === f ? {} : f; g = void 0 === g ? !1 : g; var k = new Map, m = new Map; if (void 0 !== b) g ? (e = er().extractMatchingEntries({ isJspb: g, cttAuthInfo: b }), k.set(b, e), qr(k, h, d, f)) : (k = er().extractMatchingEntries({
                    isJspb: g,
                    cttAuthInfo: b
                }), m.set(b, k), or(m, h, d, e, f)); else if (g) { e = p(Object.keys(dr)); for (g = e.next(); !g.done; g = e.next())m = g.value, g = er().extractMatchingEntries({ isJspb: !0, cttAuthInfo: m }), 0 < g.length && k.set(m, g), delete dr[m]; qr(k, h, d, f) } else { k = p(Object.keys(dr)); for (g = k.next(); !g.done; g = k.next()) { g = g.value; var q = er().extractMatchingEntries({ isJspb: !1, cttAuthInfo: g }); 0 < q.length && m.set(g, q); delete dr[g] } or(m, h, d, e, f) }
            } else f = a, k = c, h = Uq, f = void 0 === f ? {} : f, k = void 0 === k ? !1 : k, void 0 !== b ? k ? (e = new Map, k = ar.get(b) || [], e.set(b,
    ...
    function mr(a) {
        a = void 0 === a ? !1 : a; if (M("web_gel_timeout_cap") && (!a && !Wq.h || a && !Xq.h)) {
            var b = kr(function () { lr({ writeThenSend: !0 }, void 0, a) }, 6E4);
            a ? Xq.h = b : Wq.h = b
        } rr(a ? Xq.i : Wq.i); b = L("LOGGING_BATCH_TIMEOUT", Lk("web_gel_debounce_ms", 1E4)); M("shorten_initial_gel_batch_timeout") && Zq && (b = Sq); b = kr(function () { lr({ writeThenSend: !0 }, void 0, a) }, b);
        a ? Xq.i = b : Wq.i = b
    }
    function or(a, b, c, d, e, f) {
        e = void 0 === e ? {} : e; var g = Math.round(Q()), h = a.size, k = {}; a = p(a); for (var m = a.next(); !m.done; k = { Ua: k.Ua, qa: k.qa, Ea: k.Ea, Wa: k.Wa, Va: k.Va }, m = a.next()) {
            var q = p(m.value); m = q.next().value; q = q.next().value; k.qa = vb({ context: Vn(b.config_ || Un()) }); if (!Pa(q) && !M("throw_err_when_logevent_malformed_killswitch")) { d(); break } k.qa.events = q; (q = br[m]) && sr(k.qa, m, q); delete br[m]; k.Ea = "visitorOnlyApprovedKey" === m; tr(k.qa, g, k.Ea); ur(e); k.Wa = function (r) {
                M("update_log_event_config") && $h.R(function () {
                    return x(function (w) {
                        return v(w,
                            vr(r), 0)
                    })
    ...
    function qr(a, b, c, d, e) {
        d = void 0 === d ? {} : d; var f = Math.round(Q()), g = a.size, h = new Map([].concat(ia(a))); h = p(h); for (var k = h.next(); !k.done; k = h.next()) {
            var m = p(k.value).next().value, q = a.get(m); k = new ck; var r = bo(b.config_ || Un()); G(k, fj, 1, r); q = q ? xr(q) : []; q = p(q); for (r = q.next(); !r.done; r = q.next())ce(k, 3, Wj, r.value); (q = cr[m]) && yr(k, m, q); delete cr[m]; m = "visitorOnlyApprovedKey" === m; zr(k, f, m); ur(d); k = ke(k); m = wr(d, m, function (w) {
                M("update_log_event_config") && $h.R(function () {
                    return x(function (t) {
                        return v(t, vr(w),
                            0)
    ...
    ; var Rr = [{
        Bb: function (a) { return "Cannot read property '" + a.key + "'" },
        kb: {
        ...
        Bb: function (a) { return "Cannot call '" + a.key + "'" },
        kb: {
        ...
        Bb: function (a) { return a.key + " is not defined" },
        kb: { ReferenceError: [{ regexp: /(.*) is not defined/, groups: ["key"] }, { regexp: /Can't find variable: (.*)/, groups: ["key"] }] }
    }]; var Tr = { na: [], ka: [{ callback: Sr, weight: 500 }] }; function Sr(a) { if ("JavaException" === a.name) return !0; a = a.stack; return a.includes("chrome://") || a.includes("chrome-extension://") || a.includes("moz-extension://") }
    ...
    function is(a, b, c, d, e, f) {
        f = void 0 === f ? {} : f; f.name = c || L("INNERTUBE_CONTEXT_CLIENT_NAME", 1); f.version = d || L("INNERTUBE_CONTEXT_CLIENT_VERSION"); var g = f || {}, h = void 0 === b ? "ERROR" : b; h = void 0 === h ? "ERROR" : h; if (a) {
            a.hasOwnProperty("level") && a.level && (h = a.level); if (M("console_log_js_exceptions")) {
                var k = []; k.push("Name: " + a.name); k.push("Message: " + a.message); a.hasOwnProperty("params") && k.push("Error Params: " + JSON.stringify(a.params)); a.hasOwnProperty("args") && k.push("Error args: " + JSON.stringify(a.args));
                k.push("File name: " + a.fileName); k.push("Stacktrace: " + a.stack); window.console.log(k.join("\n"), a)
            } if (!(5 <= ds)) {
                var m = gs, q = xe(a), r = q.message || "Unknown Error", w = q.name || "UnknownError", t = q.stack || a.i || "Not available"; if (t.startsWith(w + ": " + r)) { var y = t.split("\n"); y.shift(); t = y.join("\n") } var E = q.lineNumber || "Not available", F = q.fileName || "Not available", O = t, N = 0; if (a.hasOwnProperty("args") && a.args && a.args.length) for (var R = 0; R < a.args.length && !(N = $r(a.args[R], "params." + R, g, N), 500 <= N); R++); else if (a.hasOwnProperty("params") &&
                    a.params) { var ca = a.params; if ("object" === typeof a.params) for (var U in ca) { if (ca[U]) { var rb = "params." + U, Va = bs(ca[U]); g[rb] = Va; N += rb.length + Va.length; if (500 < N) break } } else g.params = bs(ca) } if (m.length) for (var na = 0; na < m.length && !(N = $r(m[na], "params.context." + na, g, N), 500 <= N); na++); navigator.vendor && !g.hasOwnProperty("vendor") && (g["device.vendor"] = navigator.vendor); var I = { message: r, name: w, lineNumber: E, fileName: F, stack: O, params: g, sampleWeight: 1 }, ma = Number(a.columnNumber); isNaN(ma) || (I.lineNumber = I.lineNumber +
                        ":" + ma); if ("IGNORED" === a.level) var ea = 0; else a: { for (var Ee = Wr(), Fe = p(Ee.na), sd = Fe.next(); !sd.done; sd = Fe.next()) { var pa = sd.value; if (I.message && I.message.match(pa.zr)) { ea = pa.weight; break a } } for (var vp = p(Ee.ka), gk = vp.next(); !gk.done; gk = vp.next()) { var wp = gk.value; if (wp.callback(I)) { ea = wp.weight; break a } } ea = 1 } I.sampleWeight = ea; for (var xp = p(Rr), hk = xp.next(); !hk.done; hk = xp.next()) {
                            var ik = hk.value; if (ik.kb[I.name]) for (var yp = p(ik.kb[I.name]), jk = yp.next(); !jk.done; jk = yp.next()) {
                                var zp = jk.value, Sg = I.message.match(zp.regexp);
                                if (Sg) { I.params["params.error.original"] = Sg[0]; for (var kk = zp.groups, Ap = {}, td = 0; td < kk.length; td++)Ap[kk[td]] = Sg[td + 1], I.params["params.error." + kk[td]] = Sg[td + 1]; I.message = ik.Bb(Ap); break }
                            }
                        } I.params || (I.params = {}); var Bp = Wr(); I.params["params.errorServiceSignature"] = "msg=" + Bp.na.length + "&cb=" + Bp.ka.length; I.params["params.serviceWorker"] = "false"; z.document && z.document.querySelectorAll && (I.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length)); Cb("sample").constructor !==
                            Ab && (I.params["params.fconst"] = "true"); window.yterr && "function" === typeof window.yterr && window.yterr(I); if (0 !== I.sampleWeight && !cs.has(I.message)) {
                                if ("ERROR" === h) {
                                    Xr.ra("handleError", I); if (M("record_app_crashed_web") && 0 === fs && 1 === I.sampleWeight) if (fs++, M("errors_via_jspb")) {
                                        var lk = new yj; D(lk, 1, 1); if (!M("report_client_error_with_app_crash_ks")) { var Cp = new tj; D(Cp, 1, I.message); var Dp = new uj; G(Dp, tj, 3, Cp); var Ep = new vj; G(Ep, uj, 5, Dp); var Fp = new wj; G(Fp, vj, 9, Ep); G(lk, wj, 4, Fp) } var Gp = new Wj; ae(Gp, yj, 20,
                                            Xj, lk); Jr(Gp)
                                    } else { var Hp = { appCrashType: "APP_CRASH_TYPE_BREAKPAD" }; M("report_client_error_with_app_crash_ks") || (Hp.systemHealth = { crashData: { clientError: { logMessage: { message: I.message } } } }); jm("appCrashed", Hp) } es++
                                } else "WARNING" === h && Xr.ra("handleWarning", I); if (M("kevlar_gel_error_routing")) a: {
                                    var Ge = h; if (M("errors_via_jspb")) {
                                        if (ks()) var Jp = void 0; else {
                                            var ud = new qj; D(ud, 1, I.stack); I.fileName && D(ud, 4, I.fileName); var Lb = I.lineNumber && I.lineNumber.split ? I.lineNumber.split(":") : []; 0 !== Lb.length && (1 !==
                                            ...
                                            if (!Jk() && ok) for (var Lp = p(Object.keys(ok)), Ac = Lp.next(); !Ac.done; Ac = Lp.next()) { var Mp = Ac.value, pk = new pj; D(pk, 1, Mp); D(pk, 2, String(ok[Mp])); ce(bc, 4, pj, pk) } var qk = I.params; if (qk) { var Np = p(Object.keys(qk)); for (Ac = Np.next(); !Ac.done; Ac = Np.next()) { var Op = Ac.value, rk = new pj; D(rk, 1, "client." + Op); D(rk, 2, String(qk[Op])); ce(bc, 4, pj, rk) } } var Pp = L("SERVER_NAME"), Qp = L("SERVER_VERSION"); if (Pp && Qp) {
                                                var sk = new pj; D(sk, 1, "server.name"); D(sk, 2, Pp); ce(bc, 4, pj, sk); var tk = new pj; D(tk, 1, "server.version"); D(tk, 2, Qp); ce(bc,
                                                    4, pj, tk)
                                            } var Tg = new uj; G(Tg, nj, 1, bc); G(Tg, rj, 2, mk); G(Tg, tj, 3, zc); Jp = Tg
                                        } var Rp = Jp; if (!Rp) break a; var Sp = new Wj; ae(Sp, uj, 163, Xj, Rp); Jr(Sp)
                                    } else {
                                        if (ks()) var Tp = void 0; else {
                                            var He = { stackTrace: I.stack }; I.fileName && (He.filename = I.fileName); var Mb = I.lineNumber && I.lineNumber.split ? I.lineNumber.split(":") : []; 0 !== Mb.length && (1 !== Mb.length || isNaN(Number(Mb[0])) ? 2 !== Mb.length || isNaN(Number(Mb[0])) || isNaN(Number(Mb[1])) || (He.lineNumber = Number(Mb[0]), He.columnNumber = Number(Mb[1])) : He.lineNumber = Number(Mb[0]));
                                            var uk = { level: "ERROR_LEVEL_UNKNOWN", message: I.message, errorClassName: I.name, sampleWeight: I.sampleWeight }; "ERROR" === Ge ? uk.level = "ERROR_LEVEL_ERROR" : "WARNING" === Ge && (uk.level = "ERROR_LEVEL_WARNNING"); var dw = { isObfuscated: !0, browserStackInfo: He }, vd = { pageUrl: window.location.href, kvPairs: [] }; L("FEXP_EXPERIMENTS") && (vd.experimentIds = L("FEXP_EXPERIMENTS")); var vk = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS"); if (!Jk() && vk) for (var Up = p(Object.keys(vk)), Bc = Up.next(); !Bc.done; Bc = Up.next()) {
                                                var Vp = Bc.value; vd.kvPairs.push({
                                                    key: Vp,
                                                    value: String(vk[Vp])
                                                })
                                            } var wk = I.params; if (wk) { var Wp = p(Object.keys(wk)); for (Bc = Wp.next(); !Bc.done; Bc = Wp.next()) { var Xp = Bc.value; vd.kvPairs.push({ key: "client." + Xp, value: String(wk[Xp]) }) } } var Yp = L("SERVER_NAME"), Zp = L("SERVER_VERSION"); Yp && Zp && (vd.kvPairs.push({ key: "server.name", value: Yp }), vd.kvPairs.push({ key: "server.version", value: Zp })); Tp = { errorMetadata: vd, stackTrace: dw, logMessage: uk }
                                        } var $p = Tp; if (!$p) break a; jm("clientError", $p)
                                    } if ("ERROR" === Ge || M("errors_flush_gel_always_killswitch")) b: if (M("migrate_events_to_ts")) c: {
                                        if (M("web_fp_via_jspb") &&
                                            (Fr(!0), !M("web_fp_via_jspb_and_json"))) break c; Fr()
                                    } else { if (M("web_fp_via_jspb") && (Fr(!0), !M("web_fp_via_jspb_and_json"))) break b; Fr() }
                                } if (!M("suppress_error_204_logging")) {
                                    var Ie = I.params || {}, cc = { urlParams: { a: "logerror", t: "jserror", type: I.name, msg: I.message.substr(0, 250), line: I.lineNumber, level: h, "client.name": Ie.name }, postParams: { url: L("PAGE_NAME", window.location.href), file: I.fileName }, method: "POST" }; Ie.version && (cc["client.version"] = Ie.version); if (cc.postParams) {
                                        I.stack && (cc.postParams.stack =
                                            I.stack); for (var aq = p(Object.keys(Ie)), xk = aq.next(); !xk.done; xk = aq.next()) { var bq = xk.value; cc.postParams["client." + bq] = Ie[bq] } var yk = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS"); if (yk) for (var cq = p(Object.keys(yk)), zk = cq.next(); !zk.done; zk = cq.next()) { var dq = zk.value; cc.postParams[dq] = yk[dq] } var eq = L("SERVER_NAME"), fq = L("SERVER_VERSION"); eq && fq && (cc.postParams["server.name"] = eq, cc.postParams["server.version"] = fq)
                                    } ql(L("ECATCHER_REPORT_HOST", "") + "/error_204", cc)
                                } try { cs.add(I.message) } catch (Fx) { } ds++
                            }
            }
        }
    }
    ...
    ; var Hs = {
        ...
        var a = ub(Js), b; return (new Af(function (c, d) {
    ...
    function Uk() {
        var a = Vs(); if (void 0 !== a) return Ff(a); Us || (Us = Is().then(Ws).qb(function (b) { return Xs(2, b) }));
        return Us
    }
    ...
    ; function at() {
        var a = El.getInstance(), b = Hl(119), c = 1 < window.devicePixelRatio; if (document.body && ji(document.body, "exp-invert-logo")) if (c && !ji(document.body, "inverted-hdpi")) { var d = document.body; if (d.classList) d.classList.add("inverted-hdpi"); else if (!ji(d, "inverted-hdpi")) { var e = hi(d); ii(d, e + (0 < e.length ? " inverted-hdpi" : "inverted-hdpi")) } } else !c && ji(document.body, "inverted-hdpi") && ki(); if (b != c) {
            b = "f" + (Math.floor(119 / 31) + 1); d = Il(b) || 0; d = c ? d | 67108864 : d & -67108865; 0 == d ? delete Dl[b] : (c = d.toString(16), Dl[b] =
    ...
    function ht(a, b) {
        if (b.encryptedTokenJarContents && (a.h[b.encryptedTokenJarContents] = b, "string" === typeof b.expirationSeconds)) {
            var c = Number(b.expirationSeconds); setTimeout(function () { delete a.h[b.encryptedTokenJarContents] }, 1E3 * c);
    ...
    l.getCurrentPositionFromGeolocation = function () {
        var a = this; if (!(navigator && navigator.geolocation && navigator.geolocation.getCurrentPosition)) return Promise.reject(Error("Geolocation unsupported")); var b = !1, c = 1E4; "MWEB" === L("INNERTUBE_CLIENT_NAME") && (b = !0, c = 15E3); return new Promise(function (d, e) {
            navigator.geolocation.getCurrentPosition(function (f) { a.i = f; d(f) }, function (f) { e(f) }, {
    ...
    function rt(a) {
        var b = void 0 === b ? "UNKNOWN_INTERFACE" : b; if (1 === a.length) return a[0]; var c = qt[b]; if (c) { var d = new RegExp(c), e = p(a); for (c = e.next(); !c.done; c = e.next())if (c = c.value, d.exec(c)) return c } var f = []; Object.entries(qt).forEach(function (g) { var h = p(g); g = h.next().value; h = h.next().value; b !== g && f.push(h) });
        d = new RegExp(f.join("|")); a.sort(function (g, h) { return g.length - h.length });
        e = p(a); for (c = e.next(); !c.done; c = e.next())if (c = c.value, !d.exec(c)) return c; return a[0]
    }
    ; function st() { }
    st.prototype.m = function (a, b, c) {
        b = void 0 === b ? {} : b; c = void 0 === c ? dt : c; var d = a.clickTrackingParams, e = this.l, f = !1; f = void 0 === f ? !1 : f; e = void 0 === e ? !1 : e; var g = L("INNERTUBE_CONTEXT"); if (g) {
            g = vb(g); M("web_no_tracking_params_in_shell_killswitch") || delete g.clickTracking; g.client || (g.client = {}); var h = g.client; "MWEB" === h.clientName && (h.clientFormFactor = L("IS_TABLET") ? "LARGE_FORM_FACTOR" : "SMALL_FORM_FACTOR"); h.screenWidthPoints = window.innerWidth; h.screenHeightPoints = window.innerHeight; h.screenPixelDensity = Math.round(window.devicePixelRatio ||
                1); h.screenDensityFloat = window.devicePixelRatio || 1; h.utcOffsetMinutes = -Math.floor((new Date).getTimezoneOffset()); var k = void 0 === k ? !1 : k; El.getInstance(); var m = "USER_INTERFACE_THEME_LIGHT"; Hl(165) ? m = "USER_INTERFACE_THEME_DARK" : Hl(174) ? m = "USER_INTERFACE_THEME_LIGHT" : !M("kevlar_legacy_browsers") && window.matchMedia && window.matchMedia("(prefers-color-scheme)").matches && window.matchMedia("(prefers-color-scheme: dark)").matches && (m = "USER_INTERFACE_THEME_DARK"); k = k ? m : ft() || m; h.userInterfaceTheme = k; if (!f) {
                    if (k =
                        Ol()) h.connectionType = k; M("web_log_effective_connection_type") && (k = Pl()) && (g.client.effectiveConnectionType = k)
                } var q; if (M("web_log_memory_total_kbytes") && (null == (q = z.navigator) ? 0 : q.deviceMemory)) { var r; q = null == (r = z.navigator) ? void 0 : r.deviceMemory; g.client.memoryTotalKbytes = "" + 1E6 * q } r = cl(z.location.href); !M("web_populate_internal_geo_killswitch") && r.internalcountrycode && (h.internalGeo = r.internalcountrycode); "MWEB" === h.clientName || "WEB" === h.clientName ? (h.mainAppWebInfo = { graftUrl: z.location.href }, M("kevlar_woffle") &&
                    yl.h && (r = yl.h, h.mainAppWebInfo.pwaInstallabilityStatus = !r.h && r.i ? "PWA_INSTALLABILITY_STATUS_CAN_BE_INSTALLED" : "PWA_INSTALLABILITY_STATUS_UNKNOWN"), h.mainAppWebInfo.webDisplayMode = zl(), h.mainAppWebInfo.isWebNativeShareAvailable = navigator && void 0 !== navigator.share) : "TVHTML5" === h.clientName && (!M("web_lr_app_quality_killswitch") && (r = L("LIVING_ROOM_APP_QUALITY")) && (h.tvAppInfo = Object.assign(h.tvAppInfo || {}, { appQuality: r })), r = L("LIVING_ROOM_CERTIFICATION_SCOPE")) && (h.tvAppInfo = Object.assign(h.tvAppInfo ||
                        {}, { certificationScope: r })); if (!M("web_populate_time_zone_itc_killswitch")) { b: { if ("undefined" !== typeof Intl) try { var w = (new Intl.DateTimeFormat).resolvedOptions().timeZone; break b } catch (rb) { } w = void 0 } w && (h.timeZone = w) } (w = Mk()) ? h.experimentsToken = w : delete h.experimentsToken; w = Nk(); gt.h || (gt.h = new gt); h = gt.h.h; r = []; q = 0; for (var t in h) r[q++] = h[t]; g.request = Object.assign({}, g.request, { internalExperimentFlags: w, consistencyTokenJars: r }); !M("web_prequest_context_killswitch") && (t = L("INNERTUBE_CONTEXT_PREQUEST_CONTEXT")) &&
                            (g.request.externalPrequestContext = t); w = El.getInstance(); t = Hl(58); w = w.get("gsml", ""); g.user = Object.assign({}, g.user); t && (g.user.enableSafetyMode = t); w && (g.user.lockedSafetyMode = !0); M("warm_op_csn_cleanup") ? e && (f = Bs()) && (g.clientScreenNonce = f) : !f && (f = Bs()) && (g.clientScreenNonce = f); d && (g.clickTracking = { clickTrackingParams: d }); if (d = B("yt.mdx.remote.remoteClient_")) g.remoteClient = d; kt.getInstance().setLocationOnInnerTubeContext(g); try {
                                var y = fl(), E = y.bid; delete y.bid; g.adSignalsInfo = { params: [], bid: E }; var F =
                                    p(Object.entries(y)); for (var O = F.next(); !O.done; O = F.next()) { var N = p(O.value), R = N.next().value, ca = N.next().value; y = R; E = ca; d = void 0; null == (d = g.adSignalsInfo.params) || d.push({ key: y, value: "" + E }) }
                            } catch (rb) { is(rb) } F = g
        } else is(Error("Error: No InnerTubeContext shell provided in ytconfig.")), F = {}; F = { context: F }; if (O = this.h(a)) {
            this.i(F, O, b); var U; b = "/youtubei/v1/" + rt(this.j()); (O = null == (U = Rq(a.commandMetadata, ij)) ? void 0 : U.apiUrl) && (b = O); U = b; (b = L("INNERTUBE_HOST_OVERRIDE")) && (U = String(b) + String(oc(U))); b =
                {}; b.key = L("INNERTUBE_API_KEY"); M("json_condensed_response") && (b.prettyPrint = "false"); U = dl(U, b || {}, !1); a = Object.assign({}, { command: a }, void 0); a = { input: U, xa: Ps(U), ga: F, config: a }; a.config.ab ? a.config.ab.identity = c : a.config.ab = { identity: c }; return a
        } is(new P("Error: Failed to create Request from Command.", a))
    };
    ...
    tt.prototype.i = function () { }; var ut = {}, vt = (ut.GET_DATASYNC_IDS = ot(tt), ut); function wt(a) {
        var b = Ja.apply(1, arguments); if (!xt(a) || b.some(function (d) { return !xt(d) })) throw Error("Only objects may be merged.");
    ...
    u(Ct, uo); var Dt = new vo("aft-recorded", Ct); var Et = window; function Ft() {
    ...
    var S = Et.performance || Et.mozPerformance || Et.msPerformance || Et.webkitPerformance || new Ft; var Gt = !1, Ht = {
    ...
    function Kt() {
        var a; if (M("csi_use_performance_navigation_timing") || M("csi_use_performance_navigation_timing_tvhtml5")) {
            var b, c, d, e = null == S ? void 0 : null == (a = S.getEntriesByType) ? void 0 : null == (b = a.call(S, "navigation")) ? void 0 : null == (c = b[0]) ? void 0 : null == (d = c.toJSON) ? void 0 : d.call(c); e ? (e.requestStart = Lt(e.requestStart), e.responseEnd = Lt(e.responseEnd), e.redirectStart = Lt(e.redirectStart), e.redirectEnd = Lt(e.redirectEnd), e.domainLookupEnd = Lt(e.domainLookupEnd), e.connectStart = Lt(e.connectStart), e.connectEnd =
                Lt(e.connectEnd), e.responseStart = Lt(e.responseStart), e.secureConnectionStart = Lt(e.secureConnectionStart), e.domainLookupStart = Lt(e.domainLookupStart), e.isPerformanceNavigationTiming = !0, a = e) : a = S.timing
        } else a = S.timing; return a
    }
    ...
    ; function Wt() {
        if (S.getEntriesByType) { var a = S.getEntriesByType("paint"); if (a = jb(a, function (b) { return "first-paint" === b.name })) return Lt(a.startTime) } a = S.timing;
    ...
    ; var W = {
        ...
        LATENCY_ACTION_PAGE_NAVIGATION: 187, LATENCY_ACTION_UNKNOWN: 0
    ...
    var Y = {
        DETAILED_NETWORK_TYPE_NR_NSA: 126, DETAILED_NETWORK_TYPE_NR_SA: 125, DETAILED_NETWORK_TYPE_INTERNAL_WIFI_IMPAIRED: 124, DETAILED_NETWORK_TYPE_APP_WIFI_HOTSPOT: 123, DETAILED_NETWORK_TYPE_DISCONNECTED: 122, DETAILED_NETWORK_TYPE_NON_MOBILE_UNKNOWN: 121, DETAILED_NETWORK_TYPE_MOBILE_UNKNOWN: 120, DETAILED_NETWORK_TYPE_WIMAX: 119, DETAILED_NETWORK_TYPE_ETHERNET: 118, DETAILED_NETWORK_TYPE_BLUETOOTH: 117, DETAILED_NETWORK_TYPE_WIFI: 116, DETAILED_NETWORK_TYPE_LTE: 115, DETAILED_NETWORK_TYPE_HSPAP: 114, DETAILED_NETWORK_TYPE_EHRPD: 113,
        DETAILED_NETWORK_TYPE_EVDO_B: 112, DETAILED_NETWORK_TYPE_UMTS: 111, DETAILED_NETWORK_TYPE_IDEN: 110, DETAILED_NETWORK_TYPE_HSUPA: 109, DETAILED_NETWORK_TYPE_HSPA: 108, DETAILED_NETWORK_TYPE_HSDPA: 107, DETAILED_NETWORK_TYPE_EVDO_A: 106, DETAILED_NETWORK_TYPE_EVDO_0: 105, DETAILED_NETWORK_TYPE_CDMA: 104, DETAILED_NETWORK_TYPE_1_X_RTT: 103, DETAILED_NETWORK_TYPE_GPRS: 102, DETAILED_NETWORK_TYPE_EDGE: 101, DETAILED_NETWORK_TYPE_UNKNOWN: 0
    ...
    function su(a, b) {
        pu[b] = pu[b] || { count: 0 }; var c = pu[b]; c.count++; c.time = Q(); a.h || (a.h = Rl(function () { var d = Q(), e; for (e in pu) pu[e] && 6E4 < d - pu[e].time && delete pu[e]; a && (a.h = 0) }, 5E3));
    ...
    ; function tu() {
        var a = ["ol"]; Yt("").info.actionType = "embed"; a && Ik("TIMING_AFT_KEYS", a); Ik("TIMING_ACTION", "embed"); if (M("web_csi_via_jspb")) {
            a = L("TIMING_INFO", {}); var b = new Pj; a = p(Object.entries(a)); for (var c = a.next(); !c.done; c = a.next()) {
                var d = p(c.value); c = d.next().value; d = d.next().value; switch (c) {
                    case "GetBrowse_rid": var e = new Sj; D(e, 1, c); D(e, 2, String(d)); Rj(b, e); break; case "GetGuide_rid": e = new Sj; D(e, 1, c); D(e, 2, String(d)); Rj(b, e); break; case "GetHome_rid": e = new Sj; D(e, 1, c); D(e, 2, String(d)); Rj(b, e);
                        break; case "GetPlayer_rid": e = new Sj; D(e, 1, c); D(e, 2, String(d)); Rj(b, e); break; case "GetSearch_rid": e = new Sj; D(e, 1, c); D(e, 2, String(d)); Rj(b, e); break; case "GetSettings_rid": e = new Sj; D(e, 1, c); D(e, 2, String(d)); Rj(b, e); break; case "GetTrending_rid": e = new Sj; D(e, 1, c); D(e, 2, String(d)); Rj(b, e); break; case "GetWatchNext_rid": e = new Sj; D(e, 1, c); D(e, 2, String(d)); Rj(b, e); break; case "yt_red": D(b, 14, !!d); break; case "yt_ad": D(b, 9, !!d)
                }
            } uu(b); b = new Pj; b = D(b, 25, !0); b = D(b, 1, W[eu(L("TIMING_ACTION"))]); (a = L("PREVIOUS_ACTION")) &&
                D(b, 13, W[eu(a)]); (a = L("CLIENT_PROTOCOL")) && D(b, 33, a); (a = L("CLIENT_TRANSPORT")) && D(b, 34, a); (a = Bs()) && "UNDEFINED_CSN" !== a && D(b, 4, a); a = vu(); 1 !== a && -1 !== a || D(b, 6, !0); a = Ot(); D(b, 3, "cold"); wu(a); a = xu(); if (0 < a.length) for (a = p(a), c = a.next(); !c.done; c = a.next())c = c.value, d = new Oj, D(d, 1, c), ce(b, 83, Oj, d); uu(b)
        } else {
            a = L("TIMING_INFO", {}); for (b in a) a.hasOwnProperty(b) && yu(b, a[b]); b = { isNavigation: !0, actionType: eu(L("TIMING_ACTION")) }; if (a = L("PREVIOUS_ACTION")) b.previousAction = eu(a); if (a = L("CLIENT_PROTOCOL")) b.httpProtocol =
                a; if (a = L("CLIENT_TRANSPORT")) b.transportProtocol = a; (a = Bs()) && "UNDEFINED_CSN" !== a && (b.clientScreenNonce = a); a = vu(); if (1 === a || -1 === a) b.isVisible = !0; Ot(); b.loadType = "cold"; wu(Ot()); a = xu(); if (0 < a.length) for (b.resourceInfo = [], a = p(a), c = a.next(); !c.done; c = a.next())b.resourceInfo.push({ resourceCache: c.value }); zu(b)
        } b = Ot(); a = St(); if (!(M("skip_setting_info_in_csi_data_object") && "cold" !== Pt().loadType || "cold" !== b.yt_lt && "cold" !== a.loadType)) {
            c = Qt(); d = Rt(); d = d.gelTicks ? d.gelTicks : d.gelTicks = {}; for (var f in c) if (!(f in
                d)) if ("number" === typeof c[f]) Z(f, Jt(f)); else if (M("log_repeated_ytcsi_ticks")) { e = p(c[f]); for (var g = e.next(); !g.done; g = e.next())Z(f.slice(1), g.value) } f = {}; c = !1; d = p(Object.keys(b)); for (e = d.next(); !e.done; e = d.next())e = e.value, (e = fu(e, b[e])) && !Vt(St(), e) && (wt(a, e), wt(f, e), c = !0); c && zu(f)
        } A("ytglobal.timingready_", !0); f = L("TIMING_ACTION"); B("ytglobal.timingready_") && f && "_start" in Qt() && It() && Ut()
    }
    ...
    function zu(a, b, c) {
        if (!M("web_csi_via_jspb") || (void 0 === c ? 0 : c)) c = Yt(b || ""), wt(c.info, a), M("skip_setting_info_in_csi_data_object") && a.loadType && (c = a.loadType, Pt(b).loadType = c), wt(St(b), a), c = Tt(b), b = Nt(b).cttAuthInfo, ru().info(a, c, b); else {
            c = new Pj; var d = Object.keys(a); a = Object.values(a); for (var e = 0; e < d.length; e++) {
                var f = d[e]; try {
                    switch (f) {
                        case "actionType": D(c, 1, W[a[e]]); break; case "clientActionNonce": D(c, 2, a[e]); break; case "clientScreenNonce": D(c, 4, a[e]); break; case "loadType": D(c, 3, a[e]); break; case "isPrewarmedLaunch": D(c,
    ...
    function Bu() {
        var a = window.location.protocol, b = S.getEntriesByType("resource"); b = gb(b, function (c) { return 0 === c.name.indexOf(a + "//fonts.gstatic.com/s/") });
    ...
    function Hu(a, b, c, d) {
        if (void 0 !== Gu.h) {
            if (d = Gu.h, a = [a !== d.m, b !== d.L, c !== d.l, !1, !1, void 0 !== d.i], a.some(function (e) { return e })) throw new P("InnerTubeTransportService is already initialized", a);
        } else Gu.h = new Gu(a, b, c, d)
    }
    function Iu(a) {
        var b = { signalServiceEndpoint: { signal: "GET_DATASYNC_IDS" } }; var c = void 0 === c ? dt : c; var d = nt(b, a.m); if (!d) return Ff(new P("Error: No request builder found for command.", b)); var e = d.m(b, void 0, c); return e ? new Af(function (f) {
            var g, h, k; return x(function (m) {
                if (1 == m.h) {
                    h = "cors" === (null == (g = e.xa) ? void 0 : g.mode) ? "cors" : void 0; if (a.l.wd) { var q = e.config, r; q = null == q ? void 0 : null == (r = q.ab) ? void 0 : r.sessionIndex; r = ct({ sessionIndex: q }); k = Object.assign({}, Ju(h), r); return m.u(2) } return v(m, Ku(e.config,
                        h), 3)
                } 2 != m.h && (k = m.i); f(Lu(a, e, k)); m.h = 0
            })
        }) : Ff(new P("Error: Failed to build request for command.", b))
    }
    ...
    function Lu(a, b, c) {
        var d, e, f, g, h, k, m, q, r, w, t, y, E, F, O, N, R, ca, U, rb, Va, na, I, ma, ea, Ee, Fe, sd; return x(function (pa) {
            switch (pa.h) {
                case 1: pa.u(2); break; case 3: if ((d = pa.i) && !d.isExpired()) return pa.return(Promise.resolve(d.h())); case 2: if (null == (e = b) ? 0 : null == (f = e.ga) ? 0 : f.context) for (g = p([]), h = g.next(); !h.done; h = g.next())k = h.value, k.Cr(b.ga.context); if (null == (m = a.i) || !m.Hr(b.input, b.ga)) { pa.u(4); break } return v(pa, a.i.xr(b.input, b.ga), 5); case 5: return q = pa.i, M("kevlar_process_local_innertube_responses_killswitch") ||
    ...
    function Ju(a) {
        var b = { "Content-Type": "application/json" }; L("EOM_VISITOR_DATA") ? b["X-Goog-EOM-Visitor-Id"] = L("EOM_VISITOR_DATA") : L("VISITOR_DATA") && (b["X-Goog-Visitor-Id"] = L("VISITOR_DATA")); M("track_webfe_innertube_auth_mismatch") && (b["X-Youtube-Bootstrap-Logged-In"] = L("LOGGED_IN", !1)); "cors" !== a && ((a = L("INNERTUBE_CONTEXT_CLIENT_NAME")) && (b["X-Youtube-Client-Name"] = a), (a = L("INNERTUBE_CONTEXT_CLIENT_VERSION")) && (b["X-Youtube-Client-Version"] = a), (a = L("CHROME_CONNECTED_HEADER")) && (b["X-Youtube-Chrome-Connected"] =
    ...
    $u.prototype.handleResponse = function (a) {
    ...
    u(cv, uo); var Do = new vo("screen-created", cv), dv = [], fv = ev, gv = 0; function hv(a, b, c, d, e, f, g) {
        function h() { js(new P("newScreen() parent element does not have a VE - rootVe", b)) }
    ...
    function iv(a, b, c, d) {
        var e = d.filter(function (k) { k.csn !== b ? (k.csn = b, k = !0) : k = !1; return k }), f = {
            cttAuthInfo: Ds(b) || void 0,
            Z: b
        }; d = p(d); for (var g = d.next(); !g.done; g = d.next())g = g.value.getAsJson(), (pb(g) || !g.trackingParams && !g.veType) && js(Error("Child VE logged with no data")); if (M("il_via_jspb")) {
            var h = new Gj; h.i(b); Ij(h, c.getAsJspb()); hb(e, function (k) { k = k.getAsJspb(); ce(h, 3, Aj, k) });
            "UNDEFINED_CSN" === b ? jv("visualElementAttached", f, void 0, h) : Pr(h, f, a)
        } else c = { csn: b, parentVe: c.getAsJson(), childVes: hb(e, function (k) { return k.getAsJson() }) }, "UNDEFINED_CSN" === b ? jv("visualElementAttached", f, c) : a ? Dr("visualElementAttached", c, a, f) : jm("visualElementAttached", c, f)
    }
    ...
    pv.prototype.clickCommand = function (a, b, c) {
        var d = a.clickTrackingParams; c = void 0 === c ? 0 : c; if (d) if (c = Bs(void 0 === c ? 0 : c)) {
            a = this.client; var e = vs(d); d = { cttAuthInfo: Ds(c) || void 0, Z: c }; M("il_via_jspb") ? (b = new Jj, b.i(c), e = e.getAsJspb(), G(b, Aj, 2, e), D(b, 4, Yj.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK), "UNDEFINED_CSN" === c ? jv("visualElementGestured", d, void 0, b) : Mr(b, d, a)) : (e = { csn: c, ve: e.getAsJson(), gestureType: "INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK" }, b && (e.clientData = b), "UNDEFINED_CSN" === c ? jv("visualElementGestured",
                d, e) : a ? Dr("visualElementGestured", e, a, d) : jm("visualElementGestured", e, d)); b = !0
        } else b = !1; else b = !1; return b
    };
    ...
    function tv(a, b, c) {
        c = void 0 === c ? {} : c; a.j.add(c.layer || 0); a.l = function () { uv(a, b, c); var f = zs(c.layer); if (f) { for (var g = p(a.o), h = g.next(); !h.done; h = g.next())h = h.value, rv(a, h[0], h[1] || f, c.layer); f = p(a.v); for (g = f.next(); !g.done; g = f.next())g = g.value, sv(a, g[0], g[1]) } };
    ...
    function Sv(a, b, c, d) {
        d = void 0 === d ? null : d; var e = nf("SCRIPT"); e.id = b; e.onload = function () { c && setTimeout(c, 0) };
    ...
    var Rv = {}; var Vv = [], Wv = !1; function Xv() {
        if (!M("disable_biscotti_fetch_for_ad_blocker_detection") && !M("disable_biscotti_fetch_entirely_for_all_web_clients") && Qs()) {
            var a = L("PLAYER_VARS", {}); if ("1" != sb(a) && !Rs(a)) {
                var b = function () { Wv = !0; "google_ad_status" in window ? Ik("DCLKSTAT", 1) : Ik("DCLKSTAT", 2) };
    ...
    ; function Zv(a) {
        var b = this; var c = void 0 === c ? 0 : c; var d = void 0 === d ? Wl() : d; this.l = c; this.j = d; this.i = new Eh; this.h = a; a = {}; c = p(this.h.entries()); for (d = c.next(); !d.done; a = { Fa: a.Fa, Sa: a.Sa }, d = c.next()) {
            var e = p(d.value); d = e.next().value; e = e.next().value; a.Sa = d; a.Fa = e; d = function (f) { return function () { f.Fa.Ab(); b.h[f.Sa].mb = !0; b.h.every(function (g) { return !0 === g.mb }) && b.i.resolve() } }(a);
            e = Sl(d, $v(this, a.Fa)); this.h[a.Sa] = Object.assign({}, a.Fa, { Ab: d, jobId: e })
        }
    }
    function aw(a) {
        var b = Array.from(a.h.keys()).sort(function (d, e) { return $v(a, a.h[e]) - $v(a, a.h[d]) });
    ...
    bw.prototype.transition = function (a, b) {
        var c = this, d = this.v.find(function (f) { return Array.isArray(f.from) ? f.from.find(function (g) { return g === c.state && f.D === a }) : f.from === c.state && f.D === a });
        if (d) {
            this.j && (aw(this.j), this.j = void 0); this.state = a; d = d.action.bind(this); var e = this.plugins.filter(function (f) { return f[a] }).map(function (f) { return f[a] });
            d(ew(this, e, this.o), b)
        } else throw Error("no transition specified from " + this.state + " to " + a);
    };
    function ew(a, b, c) {
        return function () {
            var d = Ja.apply(0, arguments), e = b.filter(function (k) { var m; return 10 === (null != (m = null != c ? c : k.priority) ? m : 0) }), f = b.filter(function (k) {
                var m;
            ...
            f = f.map(function (k) {
                var m; return {
                    Ab: function () { k.callback.apply(k, ia(d)) },
    ...
    ; function ow(a, b, c) {
        J.call(this); var d = this; c = c || L("POST_MESSAGE_ORIGIN") || window.document.location.protocol + "//" + window.document.location.hostname; this.l = b || null; this.targetOrigin = "*"; this.m = c; this.sessionId = null; this.i = "widget"; this.I = !!a; this.F = function (e) {
            a: if (!("*" != d.m && e.origin != d.m || d.l && e.source != d.l || "string" !== typeof e.data)) {
                try { var f = JSON.parse(e.data) } catch (g) { break a } if (!(null == f || d.I && (d.sessionId && d.sessionId != f.id || d.i && d.i != f.channel)) && f) switch (f.event) {
                    case "listening": "null" !=
    ...
    ; function yw(a) {
        pw.call(this); this.listeners = []; this.api = a; this.addEventListener("onReady", this.onReady.bind(this)); this.addEventListener("onVideoProgress", this.qd.bind(this)); this.addEventListener("onVolumeChange", this.rd.bind(this)); this.addEventListener("onApiChange", this.ld.bind(this)); this.addEventListener("onPlaybackQualityChange", this.nd.bind(this)); this.addEventListener("onPlaybackRateChange", this.od.bind(this)); this.addEventListener("onStateChange", this.pd.bind(this)); this.addEventListener("onWebglSettingsChanged",
            this.sd.bind(this))
    }
    u(yw, pw); l = yw.prototype;
    l.Kb = function (a, b, c) {
        if (this.api.isExternalMethodAvailable(a, c)) {
            b = b || []; if (0 < b.length && vw(a)) {
                var d = b; if (Qa(d[0]) && !Array.isArray(d[0])) var e = d[0]; else switch (e = {}, a) {
                    case "loadVideoById": case "cueVideoById": e = ww(d[0], void 0 !== d[1] ? Number(d[1]) : void 0, d[2]); break; case "loadVideoByUrl": case "cueVideoByUrl": e = d[0]; "string" === typeof e && (e = { mediaContentUrl: e, startSeconds: void 0 !== d[1] ? Number(d[1]) : void 0, suggestedQuality: d[2] }); b: {
                        if ((d = e.mediaContentUrl) && (d = /\/([ve]|embed)\/([^#?]+)/.exec(d)) && d[2]) {
                            d =
                            d[2]; break b
                        } d = null
                    } e.videoId = d; e = ww(e); break; case "loadPlaylist": case "cuePlaylist": e = xw(d[0], d[1], d[2], d[3])
                }b.length = 1; b[0] = e
            } this.api.handleExternalCall(a, b, c); vw(a) && rw(this, this.wb())
        }
    };
    ...
    l.pd = function (a) {
        a = { playerState: a, currentTime: this.api.getCurrentTime(), duration: this.api.getDuration(), videoData: this.api.getVideoData(), videoStartBytes: 0, videoBytesTotal: this.api.getVideoBytesTotal(), videoLoadedFraction: this.api.getVideoLoadedFraction(), playbackQuality: this.api.getPlaybackQuality(), availableQualityLevels: this.api.getAvailableQualityLevels(), currentTimeLastUpdated_: Date.now() / 1E3, playbackRate: this.api.getPlaybackRate(), mediaReferenceTime: this.api.getMediaReferenceTime() }; this.api.getVideoUrl &&
    ...
    function Aw(a, b) {
        switch (a) {
            case "loadVideoById": return a = ww(b), [a]; case "cueVideoById": return a = ww(b), [a]; case "loadVideoByPlayerVars": return [b]; case "cueVideoByPlayerVars": return [b]; case "loadPlaylist": return a = xw(b), [a]; case "cuePlaylist": return a = xw(b), [a]; case "seekTo": return [b.seconds, b.allowSeekAhead]; case "playVideoAt": return [b.index]; case "setVolume": return [b.volume]; case "setPlaybackQuality": return [b.suggestedQuality]; case "setPlaybackRate": return [b.suggestedRate]; case "setLoop": return [b.loopPlaylists];
            case "setShuffle": return [b.shufflePlaylist]; case "getOptions": return [b.module]; case "getOption": return [b.module, b.option]; case "setOption": return [b.module, b.option, b.value]; case "handleGlobalKeyDown": return [b.keyCode, b.shiftKey, b.ctrlKey, b.altKey, b.metaKey, b.key, b.code]
        }return []
    }
    function Bw(a, b) {
        switch (a) {
    ...
    function Iw(a, b, c, d) {
        a.state = 5; try {
            var e = new Fh({ program: b, Tc: c, gd: M("att_web_record_metrics") }); e.td.then(function () { a.state = 6; d && d(b) });
            a.Ib(e)
        } catch (f) { a.state = 7, f instanceof Error && js(f) }
    }
    ...
    function $w(a) {
        if (!a.h() && !a.O) {
            var b = dx(a); if (b && "html5" === (ex(a) ? "html5" : null)) a.P = "html5", a.isReady() || gx(a); else if (hx(a), a.P = "html5", b && a.l && a.m) a.m.appendChild(a.l), gx(a); else {
                a.config && (a.config.loaded = !0); var c = !1; a.F = function () { c = !0; var d = ix(a, "player_bootstrap_method") ? B("yt.player.Application.createAlternate") || B("yt.player.Application.create") : B("yt.player.Application.create"); var e = a.config ? bx(a.config) : void 0; d && d(a.m, e, a.webPlayerContextConfig, a.Xa); gx(a) };
    ...
    function Xw(a) {
        a.ca = !1; if (a.V) for (var b in a.i) a.i.hasOwnProperty(b) && a.V(b, a.i[b]); for (var c in a.I) a.I.hasOwnProperty(c) && window.clearTimeout(Number(c)); a.I = {}; a.o = null; a.V = null; b = a.api; for (var d in b) b.hasOwnProperty(d) && (b[d] = null); b.addEventListener = function (e, f) { a.addEventListener(e, f) };
    ...
    function Yw(a) {
        a.addEventListener("WATCH_LATER_VIDEO_ADDED", function (b) { Bq("WATCH_LATER_VIDEO_ADDED", b) });
    ...
    function cx(a, b) {
        var c = b; if ("string" === typeof b) {
            if (a.ja[b]) return a.ja[b]; c = function () { var d = Ja.apply(0, arguments), e = B(b); if (e) try { e.apply(z, d) } catch (f) { is(f) } };
            a.ja[b] = c
        } return c ? c : null
    }
    function nx(a, b) {
        var c = "ytPlayer" + b + a.s; a.i[b] = c; z[c] = function (d) {
            var e = kl(function () { if (!a.h()) { try { a.K.ra(b, null != d ? d : void 0) } catch (h) { js(new P("PlayerProxy error when creating global callback", { error: h, event: b, playerId: a.s, data: d })) } var f = a.I, g = String(e); g in f && delete f[g] } }, 0);
            qb(a.I, String(e))
        };
        return c
    }
    ...
    ; var ox = {}, px = "player_uid_" + (1E9 * Math.random() >>> 0); function qx(a, b) {
        var c = "player", d = !1; d = void 0 === d ? !0 : d; c = "string" === typeof c ? mf(c) : c; var e = px + "_" + Ra(c), f = ox[e]; if (f && d) return rx(a, b) ? f.api.loadVideoByPlayerVars(a.args || null) : f.loadNewVideoConfig(a), f.api; f = new Ww(c, e, a, b, void 0); ox[e] = f; Bq("player-added", f.api); ve(f, function () { delete ox[f.getId()] });
        return f.api
    }
    ...
    ; function Ax(a, b, c) {
        b = void 0 === b ? {} : b; c = void 0 === c ? !1 : c; var d = L("EVENT_ID"); d && (b.ei || (b.ei = d)); if (b) {
            d = a; var e = void 0 === e ? !0 : e; var f = L("VALID_SESSION_TEMPDATA_DOMAINS", []), g = nc(window.location.href); g && f.push(g); g = nc(d); if (0 <= eb(f, g) || !g && 0 == d.lastIndexOf("/", 0)) if (M("autoescape_tempdata_url") && (f = document.createElement("a"), ec(f, d), d = f.href), d && (d = oc(d), f = d.indexOf("#"), d = 0 > f ? d : d.slice(0, f))) if (e && !b.csn && (b.itct || b.ved) && (b = Object.assign({ csn: Bs() }, b)), h) {
                var h = parseInt(h, 10); isFinite(h) && 0 < h &&
                    zx(d, b, h)
            } else zx(d, b)
        } if (c) return !1; if ((window.ytspf || {}).enabled) spf.navigate(a); else {
            var k = void 0 === k ? {} : k; var m = void 0 === m ? "" : m; var q = void 0 === q ? window : q; c = q.location; a = uc(a, k) + m; var r = void 0 === r ? Mh : r; a: { r = void 0 === r ? Mh : r; for (k = 0; k < r.length; ++k)if (m = r[k], m instanceof Kh && m.Yc(a)) { r = new Nb(a, Ob); break a } r = void 0 } r = r || Rb; if (r instanceof Nb) var w = Pb(r); else {
                b: if (Ih) { try { w = new URL(r) } catch (t) { w = "https:"; break b } w = w.protocol } else c: {
                    w = document.createElement("a"); try { w.href = r } catch (t) { w = void 0; break c } w =
    ...
    A("writeEmbed", function () {
        var a = L("PLAYER_CONFIG"); if (!a) { var b = L("PLAYER_VARS"); b && (a = { args: b }) } $s(!0); "gvn" === a.args.ps && (document.body.style.backgroundColor = "transparent"); a.attrs || (a.attrs = { width: "100%", height: "100%", id: "video-player" }); var c = document.referrer; b = L("POST_MESSAGE_ORIGIN"); window !== window.top && c && c !== document.URL && (a.args.loaderUrl = c); tu(); c = L("WEB_PLAYER_CONTEXT_CONFIGS").WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER; if (!c.serializedForcedExperimentIds) {
            var d = cl(window.location.href);
            d.forced_experiments && (c.serializedForcedExperimentIds = d.forced_experiments)
        } sx = qx(a, c); sx.addEventListener("onVideoDataChange", vx); sx.addEventListener("onReady", xx); a = L("POST_MESSAGE_ID", "player"); L("ENABLE_JS_API") ? ux = new yw(sx) : L("ENABLE_POST_API") && "string" === typeof a && "string" === typeof b && (tx = new Fw(window.parent, a, b), ux = new Cw(sx, tx.connection)); Xv(); M("ytidb_create_logger_embed_killswitch") || M("embeds_web_disable_nwl") || gm(); a = {}; jw || (jw = new iw); jw.install((a.flush_logs = { callback: function () { lr() } },
            a));
        M("embeds_web_disable_nwl") || rp(); M("ytidb_clear_embedded_player") && $h.R(function () {
            var e; if (!bv) {
                var f = Mq(), g = { Fb: av, wc: $u }; f.h.set(g.Fb, g); g = { Tb: { feedbackEndpoint: ot(Wu), modifyChannelNotificationPreferenceEndpoint: ot(Xu), playlistEditEndpoint: ot(Yu), subscribeEndpoint: ot(Uu), unsubscribeEndpoint: ot(Vu), webPlayerShareEntityServiceEndpoint: ot(Zu) } }; var h = kt.getInstance(), k = {}; h && (k.client_location = h); if (void 0 === m) { bt.h || (bt.h = new bt); var m = bt.h } void 0 === e && (e = f.resolve(av)); Hu(g, e, m, k); m = { Fb: Nu, xc: Gu.h };
                f.h.set(m.Fb, m); bv = f.resolve(Nu)
            } Hv()
        })
    });
    var Bx = Qk(function () { Au(); at(); pv.h || (pv.h = new pv); var a = pv.h; var b = 16623; var c = void 0 === c ? {} : c; Object.values(Hs).includes(b) || (js(new P("createClientScreen() called with a non-page VE", b)), b = 83769); c.isHistoryNavigation || a.h.push({ rootVe: b, key: c.key || "" }); a.o = []; a.v = []; c.Wb ? tv(a, b, c) : uv(a, b, c) }), Cx = Qk(function (a) { M("embeds_web_enable_load_player_from_page_show") && !a.persisted && (Au(), at()) }), Dx = Qk(function (a) {
        M("embeds_web_enable_dispose_player_if_page_not_cached_killswitch") ? yx() : a.persisted || (M("embeds_web_enable_load_player_from_page_show") ?
            yx() : Yc ? setTimeout(function () { yx() }, 0) : yx())
    }), Ex = Qk(yx);
