...
function showExamples(exampleId1, tabElement) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    var tab2 = document.querySelector('[data-tab-for="example1"]');
    showExamples('example1', tab2);
  });

  function showExamples2(exampleId1, tabElement) {
    var examples = document.getElementsByClassName('exa');
    var tabs = document.getElementsByClassName('tab');
  ...
  // 当文档加载完成时，自动显示并激活Tab 2，并初始化BeforeAfter
  document.addEventListener('DOMContentLoaded', function() {
    var tab3 = document.querySelector('[data-tab-for="s_exa1"]');
    showExamples2('s_exa1', tab3);
  });
